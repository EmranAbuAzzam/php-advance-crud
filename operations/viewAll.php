...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo ("
        ...
        ."<img src='$img' style='border-radius:50%;height:50px;width:50px; margin-right:3px;'/>"
        ." ".$row['name']."</td>".
        "<td>".$row['address']."</td>".
        "<td>$".$row['salary']."</td>".
        "<td>
        ...
        <a href='delete.php?id=".$row['id']."'><i class='bi bi-trash-fill text-danger fs-5 mx-2'></i></a>
        </td>"
        ."</tr>
    ");
  }
