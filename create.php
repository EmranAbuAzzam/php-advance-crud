            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" value="addEmployee" name="addEmployee" class="btn btn-secondary btn-block">Add Employee</button>
                    </div>
                </div>
            </div>
        </div>

        <a class="btn btn-outline-secondary fs-4 mb-4 " href="./index.php">back</a>
    </div>
</form>
